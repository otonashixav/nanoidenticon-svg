import { createSvg, SvgAttrs } from "./utils";
...
export function createNanoidenticon(address: string): SvgAttrs {
...
export function createNanoidenticonSvg(address: string) {
  return createSvg(createNanoidenticon(address));
}
